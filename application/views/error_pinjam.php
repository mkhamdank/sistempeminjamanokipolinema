...
<div class="container">
  ...
  <div class="jumbotron" style="background-color: black">
    <div class="container">
      <h2 style="color: yellow" class="text-center"><b>Maaf, Alat yang Anda pinjam lebih dari stok, silahkan cek stok lagi</b></h2>
      <div class="col-lg-12 text-center">
        <img src="<?php echo base_url('assets/img/stopnarkoba.png') ?>" width="95px">
      </div>
        <a class="btn btn-default btn-lg text-center" href="<?php echo site_url('peminjaman_controller') ?>" style="background-color: yellow">LIHAT DATA ALAT</a>
    </div>
  </div>
</div>
  </div>
