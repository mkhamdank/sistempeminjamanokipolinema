...
<div>
    <div class="container">
      <legend class="text-center"><b>SELAMAT DATANG DI UKM SENI THEATRISTIC POLINEMA</b></legend>
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
          <?php foreach ($theatristic as $key) { ?>
          <div class="table-info">
            <table class="table">
              <thead>
                ...
                <tr>
                  <th>Nama Ketua Umum</th>
                  <td><?php echo $key->nama_ketum ?></td>
                </tr>
                <tr>
                  <th>Jumlah Anggota</th>
                  <td><?php echo $key->jumlahanggota ?></td>
                </tr>
                <tr>
                  <th>Nama RT</th>
                  <td><?php echo $key->nama_rt ?></td>
                </tr>
                <tr>
                  <th>CP RT</th>
                  <td><?php echo $key->cp_rt ?></td>
                </tr>
                <tr>
                  <th>Data Alat</th>
                  <td><a class="btn btn-default" href="<?php echo site_url('dataalat/alattheatristic/').$key->no_ukm ?>">Data Alat</a></td>
                </tr>
              </thead>
            </table>
          </div>
