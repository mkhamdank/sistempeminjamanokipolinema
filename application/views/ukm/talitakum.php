...
<div>
    <div class="container">
      <legend class="text-center"><b>SELAMAT DATANG DI UKM TALITAKUM POLINEMA</b></legend>
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
          <?php foreach ($talitakum as $key) { ?>
          <div class="table-info">
            <table class="table">
              <thead>
                ...
                <tr>
                  <th>Data Alat</th>
                  <td><a class="btn btn-default" href="<?php echo site_url('dataalat/alattalitakum/').$key->no_ukm ?>">Data Alat</a></td>
                </tr>
              </thead>
            </table>
          </div>
