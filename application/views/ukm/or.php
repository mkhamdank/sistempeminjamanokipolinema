...
<div>
    <div class="container">
      <legend class="text-center"><b>SELAMAT DATANG DI UKM OLAHRAGA POLINEMA</b></legend>
          ...
          <div class="table-info">
            <table class="table">
              <thead>
                ...
                <tr>
                  <th>Data Alat</th>
                  <td><a class="btn btn-default" href="<?php echo site_url('dataalat/alator/').$key->no_ukm ?>">Data Alat</a></td>
                </tr>
              </thead>
            </table>
          </div>
