...
<div>
    <div class="container">
        <legend>DATA ALAT <?php foreach ($ukm as $key) {
          echo $key->nama_ukm;
        } ?></legend>
        <a href="<?php echo site_url('admin_ukm_controller/create_alat') ?>" class="btn btn-default">Tambah Alat</a>
            ...
            <tbody>
                <?php foreach ($alat as $key) { ?>
                    <tr>
                        ...
                        <td><?php foreach ($ukm as $val) {
                              echo $val->nama_ukm;
                            } ?>
                        </td>
                        <td>
                          <a href="<?php echo site_url('admin_ukm_controller/edit_alat/'.$key->kode_alat) ?>" class="btn btn-default">Edit</a>
                          <a href="<?php echo site_url('admin_ukm_controller/delete_alat/'.$key->kode_alat) ?>" class="btn btn-default">Hapus</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
