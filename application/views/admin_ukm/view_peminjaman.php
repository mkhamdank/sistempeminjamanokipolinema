...
<div>
    <div class="container">
        <legend>DATA PEMINJAMAN <?php foreach ($ukm as $key) {
          echo $key->nama_ukm;
        } ?> YANG BELUM KEMBALI</legend>
            ...
            <tbody>
                <?php foreach ($peminjaman as $key) { ?>
                    <tr>
                        ...
                        <td>
                          <a href="<?php echo site_url('admin_ukm_controller/kembalikan/'.$key->id_peminjaman) ?>" class="btn btn-default">Kembalikan</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
        ...
        <div class="table-responsive">
          <table class="table table-condensed">
            ...
            <tbody>
                <?php foreach ($peminjaman_terlambat as $key) { ?>
                    <tr>
                        <td><?php echo $key->nama_alat ?></td>
                        <td><?php echo $key->jml ?></td>
                        <td><?php echo $key->kondisi_alat ?></td>
