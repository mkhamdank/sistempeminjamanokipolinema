...
<div>
    <div class="container">
      <legend class="text-center"><b>SELAMAT DATANG DI DATA ALAT LPM KOMPEN POLINEMA</b></legend>
          <?php foreach ($alat as $key) { ?>
          <a class="btn btn-default" href="<?php echo site_url('dataukm/kompen/') ?>">Kembali</a>
