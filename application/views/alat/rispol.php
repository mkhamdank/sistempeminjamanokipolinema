...
<div>
    <div class="container">
      <legend class="text-center"><b>SELAMAT DATANG DI DATA ALAT RISPOL POLINEMA</b></legend>
          <?php foreach ($alat as $key) { ?>
          <a class="btn btn-default" href="<?php echo site_url('dataukm/rispol/') ?>">Kembali</a>
