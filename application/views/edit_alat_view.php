...
<div class="container">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    ...
    <?php echo form_open('peminjaman_controller/edit_dataalat/'.$this->uri->segment(3));?>
    <legend style="color: yellow">Edit Daftar Alat</legend>
...
?>
      ...
      <button style="background-color: yellow" type="submit" class="btn btn-default">Edit</button>
      <?php echo form_close();?>
</div>
  </div>
</div>
