...
<div>
    <div class="container">
        ...
        <?php echo form_open('admin_controller/edit_user/'.$this->uri->segment(3)); ?>
        <?php foreach ($user as $key) { ?>
          <div class="form-group">
            <label for="">Username</label>
            <input type="text" class="form-control" id="" placeholder="Username" name="username" value="<?php echo $key->username ?>">
          </div>
          <div class="form-group">
            <label for="">Retype Password</label>
            <input type="password" class="form-control" id="" placeholder="Retype Password" name="password">
          </div>

          <label for="">Sebagai</label>          
          <select name="level" id="inputLevel" class="form-control">
            <option value="<?php echo $key->level ?>"></option>
